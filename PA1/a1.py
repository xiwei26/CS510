...
speed_in_x= raw_input("what's the velosity in x axis: ") #can be double
speed_in_y = raw_input("what's the velosity in y axis: ") #can be double
...
for i in range (start_frame,end_frame + 1):
	...
	pts2 = np.float32([[0,0],[0,output_ht-1],[output_wd_1,0]])
